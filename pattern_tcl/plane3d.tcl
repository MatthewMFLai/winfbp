...
proc add_plane {p_vertex_1 p_vertex_2 p_vertex_3 p_plane} {
    ...
    lappend vertex_3(&plane_list) $p_plane
}

proc remove_plane {p_vertex_1 p_vertex_2 p_vertex_3 p_plane} {
    upvar #0 $p_vertex_1 vertex_1
    upvar #0 $p_vertex_2 vertex_2
    upvar #0 $p_vertex_3 vertex_3
    upvar #0 $p_plane plane
    ...
    set data $vertex_3(&plane_list)
    set idx [lsearch $data $p_plane]
    if {$idx > -1} {
        set vertex_3(&plane_list) [lreplace $data $idx $idx]
    } else {
        return -2
    }
...
proc get_plane {p_vertex_1 p_vertex_2 p_vertex_3} {
    upvar #0 $p_vertex_1 vertex_1
    upvar #0 $p_vertex_2 vertex_2
    upvar #0 $p_vertex_3 vertex_3
    ...
    set planelist3 $vertex_3(&plane_list)
